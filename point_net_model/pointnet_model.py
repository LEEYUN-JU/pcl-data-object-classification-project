...
data_dir = r"C:\Users\.keras\datasets\ModelNet10"
...
def parse_dataset(num_points=2048):
    ...
    test_labels = []
    class_map = {}
    folders = os.listdir(r'C:\Users\.keras\datasets\ModelNet10')
...
for i in range(8):
    ...
    ax.set_title("pred: {:}, label: {:} \n".format(CLASS_MAP[preds[i].numpy()], CLASS_MAP[labels[i].numpy()]))
    ax.set_axis_off()
plt.show()
